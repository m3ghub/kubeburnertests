#!/bin/bash
# Test 22C Live Monitor — streams a status snapshot every 30s to stdout
# Run alongside the churn job: oc logs -f job/kb-test22c-monitor -n burner-test22c
...
echo "============================================================"
echo "  TEST 22C HIGH-DENSITY PROGRESSIVE CHURN MONITOR"
