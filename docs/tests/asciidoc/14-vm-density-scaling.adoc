...
NOTE: Live run results on this cluster (kube-burner v2.6.1, CirrOS): 2 VMs = 12s P99, 5 VMs = 19s P99. Faster than the original estimates — pre-loading images to all nodes before the run accounts for most of the improvement.
