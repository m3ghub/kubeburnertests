...
_Category:_ OpenShift Virtualization — Live Migration  
_Namespace:_ `burner-migration-escalation`  
_Escalation:_ 2 → 4 → 8 → 16 → 32 VMs  
_Duration:_ ~45–90 min  
...
For the full config, see the downloaded file or the link:https://github.com/m3ghub/kubeburnertests/blob/main/docs/tests/files/13a-vm-live-migration-escalation/migration-escalation-config.yml[repo].
...
_Expected log output per round:_
...
* link:13-vm-live-migration.md[13-vm-live-migration.md] — Single-shot migration test
* link:09a-kubevirt-density-escalation.md[09a-kubevirt-density-escalation.md] — CirrOS density escalation
