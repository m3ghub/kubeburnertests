...
____
_`storageClassName: ""`_ — leave blank to use your cluster's default storage class. To use a specific class, replace `""` with the class name from `oc get storageclass`.
____
