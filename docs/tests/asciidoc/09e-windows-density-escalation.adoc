...
____
____
_Time to run:_ 4–8 hours (3 rounds unattended)  
____
____
_What it does:_ Automatically escalates through 3 rounds of increasing Windows Server 2022 VM density — find your cluster's Windows VM ceiling  
____
____
_Requires:_ OpenShift Virtualization 4.x, `win2k22` golden PVC `Ready: True`, 500Gi+ free storage  
____
____
_Companion test:_ Run link:09d-windows-density.md[Test 09d] first to confirm Windows VMs boot successfully. This test is the escalation.
____
...
____
_STIG / quota-enforced clusters:_ Use the quota-safe Job variant in Step 5. See link:../../concerns/CONCERN-013-stig-resource-quota.md[CONCERN-013].
____

____
⚠️ _Golden image required:_ `win2k22` PVC must be `Ready: True`. See link:../../concerns/CONCERN-007-windows-golden-image-missing.md[CONCERN-007].
____

'''

!link:../../diagrams/tests/png/09e-windows-density-escalation.png[Diagram]
...
____
_Why only 3 rounds and smaller numbers than RHEL?_  
____
____
...
____
_Storage is the hard limit._ 8 Windows VMs = 400Gi of PVC clones. Check your storage class capacity and throughput before running Round 3.
____
...
| Test | OS | VMs | Purpose |
|---|---|---|---|
| link:09-kubevirt-density.md[09] | CirrOS | 3 | Baseline |
| link:09a-kubevirt-density-escalation.md[09a] | CirrOS | 5→100 | CirrOS ceiling |
| link:09b-rhel-density.md[09b] | RHEL 9 | 3 | RHEL baseline |
| link:09c-rhel-density-escalation.md[09c] | RHEL 9 | 3→15 | RHEL ceiling |
| link:09d-windows-density.md[09d] | Windows 2022 | 3 | Windows baseline |
| _09e_ (this test) | Windows 2022 | 3→8 | Windows ceiling |
| link:24-vm-density-windows.md[24] | Windows 2022 | fleet | Production fleet |

'''

_Previous: link:09d-windows-density.md[Test 09d — Windows Density] | Production scale: link:24-vm-density-windows.md[Test 24 — Windows Fleet]_
